...
public class User : BaseEntity, IUser
{
    ...
    /// <summary>
    /// Ensures that the user satisfies all critical business rules.
    ...
    public void EnsureBusinessRulesAreMet()
    {
        ...
        if (Status == UserStatus.Active && Password.Length < 8)
        {
            throw new DomainException("Active users must have a secure password of at least 8 characters.");
        }
    }
