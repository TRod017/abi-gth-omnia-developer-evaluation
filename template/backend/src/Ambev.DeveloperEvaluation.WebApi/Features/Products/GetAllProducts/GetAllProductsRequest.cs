...
/// <summary>
/// Represents the request used to retrieve a paginated list of products.
/// </summary>
/// <remarks>
/// Supports pagination parameters via query string.
/// </remarks>
public class GetAllProductsRequest : IRequest<PaginatedResponse<GetAllProductsResult>>
{
    /// <summary>
