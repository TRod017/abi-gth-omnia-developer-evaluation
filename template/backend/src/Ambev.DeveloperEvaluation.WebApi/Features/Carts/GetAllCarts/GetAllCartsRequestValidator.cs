...
/// <summary>
/// Validator for <see cref="GetAllCartsRequest"/> that defines pagination rules.
/// </summary>
/// <remarks>
/// Ensures that:
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GetAllCartsRequestValidator"/> class
    /// and sets up pagination rules for cart listing requests.
    /// </summary>
