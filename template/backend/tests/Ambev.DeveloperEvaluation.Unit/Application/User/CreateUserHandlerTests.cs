...
using Ambev.DeveloperEvaluation.Unit.Application.TestData.User;
using AutoMapper;
...
public class CreateUserHandlerTests
{
    ...
    public async Task Handle_ValidRequest_MapsCommandToUser()
    {
        ...
        // Then
        _mapper.Received(1).Map<Ambev.DeveloperEvaluation.Domain.Entities.User>(Arg.Is<CreateUserCommand>(c =>
