...
public class DeleteCartValidatorTests
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteCartValidatorTests"/> class.
    /// </summary>
    ...
    {
        var command = new DeleteCartCommand { Id = System.Guid.NewGuid() };
    ...
    {
        var command = new DeleteCartCommand { Id = System.Guid.Empty };
